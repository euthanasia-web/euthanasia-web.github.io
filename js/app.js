...
(function() {
    ...
    paymentVars.forEach(function(paymentVar, i) {
        paymentVar.addEventListener('click', function() {
            ...
            orderBtn.href = premiumEdition ? 'https://forms.gle/zShRCKHaC2LdDafZ6' : 'https://forms.gle/gfGbnGTGE5N45vSY8';
            premiumEdition = !premiumEdition;
        });
    });
    ...
    if (codeInputTrigger && codeBlock && codeInput && codeSubmit) {
